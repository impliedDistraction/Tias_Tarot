...
class FullScreenModalDateRequest extends ModalRoute {
  ...
  DateRangePickerSelectionChangedArgs? lastValue;
  ...
  usePressedAction(BuildContext context) {
    return () {
      if(lastValue == null || validate(lastValue!.value) == false) {
